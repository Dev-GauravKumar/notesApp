    ...
    return WillPopScope(
      ...
      child: Scaffold(
          ...
          floatingActionButton: FloatingActionButton(
            ...
            /*() async {
              await Navigator.push(context,
                  MaterialPageRoute(builder: (context) => const addEditNote(type:'standard')));
              refreshNotes();
            }*/
            ),
          ),
        ...
        itemBuilder: (context, index) => Padding(
              ...
              child: ListTile(
                ...
                title: notes[index].title==''
                    ...
                    ?Text(notes[index].description.substring(0,notes[index].description.indexOf('\n')),overflow: TextOverflow.ellipsis,)
                :Text(notes[index].description,overflow: TextOverflow.ellipsis,)
                :Text(notes[index].title,overflow: TextOverflow.ellipsis,),
                subtitle: Column(
                  ...
                  children: [
                    ...
                    :notes[index].title==''
                        ...
                        ?notes[index].description.indexOf('\n')!=notes[index].description.lastIndexOf('\n')
                        ?Text(notes[index].description.substring(notes[index].description.indexOf('\n')+1,notes[index].description.indexOf('\n',notes[index].description.indexOf('\n')+1)),overflow: TextOverflow.ellipsis,)
                        :Text(notes[index].description.substring(notes[index].description.indexOf('\n')+1,notes[index].description.length).replaceAll('\n', ' '))
                        :SizedBox()
                        :SizedBox()
                        :notes[index].description.contains('\n')
                        ?Text(notes[index].description.substring(0,notes[index].description.indexOf('\n')),overflow: TextOverflow.ellipsis)
                    ...
                    notes[index].createdTime.day == DateTime.now().day &&
                        notes[index].createdTime.month ==
                            DateTime.now().month &&
                        notes[index].createdTime.year == DateTime.now().year
                        ? Text(
